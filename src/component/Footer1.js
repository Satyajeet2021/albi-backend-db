...
export default function Footer() {
  ...
  <div className=" container mx-auto py-8 ">
    <div className=" w-full">
      <div className='flex flex-col sm:flex-row md:flex-row lg:flex-row xl:flex-row 2xl:flex-row justify-between items-center container mx-auto space-x-10'>
        <div className='flex flex-auto w-32justify-between align-center'>
      ...
      <div className="flex flex-row sm:flex-col md:flex-col lg:flex-col xl:flex-col 2xl:flex-col flex-auto justify-around w-full sm:w-32 md:w-32 lg:w-32 xl:w-32 2xl:w-32 address">
        <h6 className="flex justify-center md:justify-start">
         Zona e Re Industriale, Veternik <br/>
10000 Prishtinë, Kosovë
        </h6>
        <h6 className="mb-3 flex justify-center md:justify-start"></h6>
        <h6 className="mb-3 flex justify-center md:justify-start"></h6>
        <h6 className="mb-3 flex justify-center md:justify-start"></h6>
        <h6 className="flex justify-center md:justify-start">
         048 300 800 <br/>info@albionline.com
        </h6> 
        
         
      </div>
      <div className="flex-col flex-auto w-64 justify-center items-center mt-10 hidden sm:flex md:flex lg:flex xl:flex 2xl:flex">
      <div className="form-group form-group w-full">
            ...
            <div className="input-group-prepend">
              <span className="input-group-text">
                <svg width="19.642" height="15.714" viewBox="0 0 19.642 15.714">
                  ...
                  <input placeholder="Email" name="email" type="email" className="form-control form-control--newsletter form-control" aria-invalid="false" value=""/>
...
<p className="text-left socialicons">Payment methods</p>
...
{/*##########*/}
  ...
  <div className="text-center footercopyright">
    ...
    <a
      ...
      href="#"
    >
     All authorized rights © Albi Online 2022
    </a>
  </div>
</footer>
