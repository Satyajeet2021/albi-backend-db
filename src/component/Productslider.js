...
export default function Productslider() {
  ...
  return (
    <div className="flex container py-4 mx-auto 1st">
          ...
          <SwiperSlide>
            <Link to={`/productdetails/${dt._id}/${dt.catId}`}>
              ...
              <div className="ProductItem__image">
                ...
                {dt?.sale_price <= 0 || dt?.sale_price == '' || dt.regular_price <= 0 ? '':
