...
import slider1 from '../assets/slider/kids/slider-1.jpg';
// import slider2 from '../assets/slider/kids/slider-2.jpg';
// import slider3 from '../assets/slider/kids/slider-3.jpg';
import banner1 from '../assets/slider/kids/section2-1.jpg';
import banner2 from '../assets/slider/kids/section2-2.jpg';
import banner3 from '../assets/slider/kids/section2-3.jpg';
import image1 from '../assets/slider/kids/section5-image1.png';
import image2 from '../assets/slider/kids/section5-image2.png';
import image3 from '../assets/slider/kids/section5-image3.png';
import image4 from '../assets/slider/kids/section5-image4.png';
...
import video from '../assets/slider/kids/kids-video.mp4';
...
<div class="cover-section">
        <div id="mycarousel" class="carousel carousel-fade " data-bs-ride="carousel" data-bs-interval="6000">
            ...
            <div class="carousel-inner kids-slider">
              <div class="carousel-item active">
                <img src={slider1} alt="" width="100%" />
                <div class="carousel-heading kids-sec">
                  <div class="caption-1 animate__animated animate__slideInUp">New Collection</div>
                  <div class="caption-2 animate__animated animate__slideInUp">FËMIJË</div>
                  <div class="caption-3 animate__animated animate__slideInUp">TË LUMTUR</div>
                  <div class="caption-4 animate__animated animate__slideInUp">Rehati në çdo hapësirë</div>
                  <div class="caption-link slider-btn animate__animated animate__slideInUp">
                    <NavLink to="/brands/kids/mango"><span>SHIKO KOLEKSIONIN</span></NavLink>
                  </div>
                </div>
              </div>
    ...
    <div class="section-2">
        <div class="container">
            ...
            <div class="row spacing-30 kids-section2">
               <div class="col-lg-8 cl-md-8 .col-xs-12 group-1">
                  <div class="gallery-image__item hover-image mbb">
                    <NavLink to="/Triko/3.1.3">
                       <div class="response-image">
                         <img src={banner1} alt=""  width="100%" />
                       </div>
                    </NavLink>
                    <div class="gallery-image__caption y kidsec2">
                        <div class="title-block text-uppercase">Gati për çdo aventurë</div>
                        <div class="sub-block">Rehati për fëmiun tuaj</div>
                        <div class="button-block"><NavLink to="/Triko/3.1.3" class="text-uppercase text-white" style={{color:"#fff"}}>Shop the collection</NavLink></div>
                    </div>
                  </div>
               </div>
               <div class="col-lg-4 cl-md-4 .col-xs-12 group-2">
                <div class="mb-4">
                  <div class="gallery-image__item hover-image">
                    <NavLink to="/Xhinse/3.1.11">
                      <div class="response-image">
                        <img src={banner2} alt="" width="100%" />
                      </div>
                      <div class="gallery-image__caption kidsec2">
                        <div class="title-block text-uppercase">Ndjenjë e  veçantë</div>
                        <div class="sub-block">E pa zëvëndesueshme</div>
                        <div class="button-block"><NavLink to="/Xhinse/3.1.11" class="text-uppercase text-white" style={{color:"#fff"}}>Shop the collection</NavLink></div>
                    </div>
                    </NavLink>
                  </div>
                </div>
                <div>
                  <div class="gallery-image__item hover-image">
                    <NavLink to="/Fustan/3.1.2">
                      <div class="respone-image">
                        <img src={banner3} alt="" width="100%" />
                      </div>
                      <div class="gallery-image__caption kidsec2">
                        <div class="title-block text-uppercase">Moment kënaqësie</div>
                        <div class="sub-block">Okaidi, zhgjedhja ime</div>
                        <div class="button-block"><NavLink to="/Fustan/3.1.2" class="text-uppercase text-white" style={{color:"#fff"}}>Shop the collection</NavLink></div>
                    </div>
                    </NavLink>
                  </div>
                </div>
