  ...
  return (
    ...
    <div className="flex flex-col sm:flex-row md:flex-row lg:flex-row xl:flex-row 2xl:flex-row container items-center justify-center mx-auto">
      <div className="w-full sm:w-6/12 md:w-6/12 lg:w-6/12 xl:w-6/12 2xl:w-6/12  justify-center items-center py-4 sm:py-4 md:py-4 lg:py-8 xl:py-8 3xl:py-8">
        <h1 className="text-3xl sm:text-xl md:text-5xl lg:text-5xl xl:text-5xl 2xl:text-5xl py-2 sm:py-2 md:py-2 lg:py-5 xl:py-5 3xl:py-5 text-white ">The key to elegance</h1>
        <p className="text-lg sm:text-sm md:text-md lg:text-md xl:text-md 2xl:text-md text-gray-200 pb-2 sm:pb-2 md:pb-2 lg:pb-5 xl:pb-5 3xl:pb-5">Complete your look </p>
